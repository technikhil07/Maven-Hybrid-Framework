...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable{
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			System.setProperty("webdriver.chrome.driver", "D:\\Selenium_FrameWorks\\ERP_Maven\\CommonDrivers\\chromedriver.exe");
	...
	//method for close browser
		...
		public static void captureData(WebDriver driver, String locatortype, String locatorvalue) throws IOException{
			...
			FileWriter fw = new FileWriter("D:\\Selenium_FrameWorks\\ERP_Maven\\CaptureData\\supplier.txt");
		...
		public static void tableValidation(WebDriver driver, String column)throws Throwable{
			FileReader fr  = new FileReader("D:\\Selenium_FrameWorks\\ERP_Maven\\CaptureData\\supplier.txt");
